...
def plot_model_comparison(results_dict):
    ...
    plt.tight_layout()
    plt.savefig('analysis_model_comparison.png')
...
def analyze_phoneme_performance(y_true, y_pred, phoneme_encoder):
    ...
    # Save CSV
    df_rep.to_csv("analysis_phoneme_metrics.csv")
    ...
    plt.tight_layout()
    plt.savefig('analysis_phoneme_performance.png')
    print("Saved 'analysis_phoneme_performance.png' (Visualizes hard vs. easy sounds)")
...
def plot_accuracy_by_word_length(test_df, models, model_names, g_enc, p_enc):
    ...
    plt.tight_layout()
    plt.savefig('analysis_accuracy_by_length.png')
    print("Saved 'analysis_accuracy_by_length.png'")
...
def analyze_word_errors(test_df, models, model_names, g_enc, p_enc):
    ...
    hardest_words.to_csv("analysis_hardest_words.csv", index=False)
    print("Saved list of hardest words to 'analysis_hardest_words.csv'")