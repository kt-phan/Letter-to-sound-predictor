'''
Purpose: Given an association matrix produced in 02a_em_step.py,
        aligns all word-phoneme pairs and store the results
'''
import pandas as pd
import numpy as np
from modules.em_step import em_step, MATRIX_FILE
from modules.dp_utilities import needleman_wunsch, trace_back
...
def main():
    ...
    # store dataFrame
    print()
    output_path = 'data/processed_data/cmu_dict_cleaned_filtered_aligned.csv'
