...
# 1️⃣ Set paths
input_file = "data/cmu_dict/cmudict.dict"      # Path to your downloaded CMU dictionary
output_file = "data/processed_data/cmu_dict_cleaned.csv"      # Where the cleaned CSV will be saved
